...
#include <libsnark/zk_proof_systems/ppzksnark/voteSAVER/r1cs_gg_ppzksnark_params.hpp>
...
template<typename ppT>
std::ostream& operator<< (std::ostream& out,const r1cs_gg_ppzksnark_keypair<ppT> &keypair);

template<typename ppT>
std::istream& operator>> (std::istream& in,r1cs_gg_ppzksnark_keypair<ppT> &keypair); 
...
public:
    ...
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_gg_ppzksnark_keypair<ppT> &keypair);
    friend std::istream& operator>> <ppT>(std::istream& in,r1cs_gg_ppzksnark_keypair<ppT> &keypair); 
...
#include <libsnark/zk_proof_systems/ppzksnark/voteSAVER/r1cs_gg_ppzksnark.tcc>
