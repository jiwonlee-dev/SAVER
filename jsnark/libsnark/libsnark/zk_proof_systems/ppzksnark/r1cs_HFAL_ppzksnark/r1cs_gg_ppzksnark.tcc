                                               ...
                                               const r1cs_gg_ppzksnark_proof<ppT> &proof)
{
    ...
    //    pvk.gamma_ABC_g1.template accumulate_chunk<libff::Fr<ppT> >(primary_input.begin(), primary_input.end(), 0);
    const libff::G1<ppT> &acc = cx.first;
                                        ...
                                        const r1cs_gg_ppzksnark_proof<ppT> &proof)
{
    ...
    bool result = r1cs_gg_ppzksnark_online_verifier_weak_IC<ppT>(pvk, cx, proof);
                                                 ...
                                                 const r1cs_gg_ppzksnark_proof<ppT> &proof)
{
    ...
    // else
    // {
    //     result = r1cs_gg_ppzksnark_online_verifier_weak_IC(pvk, cx, proof);
    // }
    result = r1cs_gg_ppzksnark_online_verifier_weak_IC(pvk, cx, proof);
                                          ...
                                          const r1cs_gg_ppzksnark_proof<ppT> &proof)
{
    ...
    r1cs_gg_ppzksnark_processed_verification_key<ppT> pvk = r1cs_gg_ppzksnark_verifier_process_vk<ppT>(vk);
    bool result = r1cs_gg_ppzksnark_online_verifier_strong_IC<ppT>(pvk, cx, proof);
