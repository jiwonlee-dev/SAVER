#ifndef R1CS_HFAL_PPZKSNARK_TCC_
#define R1CS_HFAL_PPZKSNARK_TCC_
...
//#include <libsnark/zk_proof_systems/ppzksnark/r1cs_HFAL_ppzksnark.hpp>

namespace libsnark
{

template <typename ppT>
bool r1cs_HFAL_ppzksnark_pp<ppT>::operator==(const r1cs_HFAL_ppzksnark_pp<ppT> &other) const
{
...
template <typename ppT>
bool r1cs_HFAL_ppzksnark_proving_key<ppT>::operator==(const r1cs_HFAL_ppzksnark_proving_key<ppT> &other) const
{
...
template <typename ppT>
std::istream &operator>>(std::istream &in, const r1cs_HFAL_ppzksnark_proving_key<ppT> &pk)
{
    in >> pk.F_g1;
    libff::consume_OUTPUT_NEWLINE(in);
    in >> pk.T_g1;
...
template <typename ppT>
bool r1cs_HFAL_ppzksnark_verification_key<ppT>::operator==(const r1cs_HFAL_ppzksnark_verification_key<ppT> &other) const
{
...
template <typename ppT>
std::istream &operator>>(std::istream &in, const r1cs_HFAL_ppzksnark_verification_key<ppT> &vk)
{
    in >> vk.delta_g1;
    libff::consume_OUTPUT_NEWLINE(in);
    in >> vk.k_g1;
...
template <typename ppT>
bool r1cs_HFAL_ppzksnark_proof<ppT>::operator==(const r1cs_HFAL_ppzksnark_proof<ppT> &other) const
{
...
r1cs_HFAL_ppzksnark_pp<ppT> r1cs_HFAL_ppzksnark_xp2_setup(const r1cs_gg_ppzksnark_primary_input<ppT> &primary_input){
    ...
    r1cs_HFAL_ppzksnark_pp<ppT> pp = r1cs_HFAL_ppzksnark_pp<ppT>(std::move(H_vector));
...
template <typename ppT>
r1cs_HFAL_ppzksnark_hash<ppT> r1cs_HFAL_ppzksnark_xp2_hash(const r1cs_HFAL_ppzksnark_pp<ppT> &pp, const r1cs_gg_ppzksnark_primary_input<ppT> &primary_input){
    ...
    r1cs_HFAL_ppzksnark_hash<ppT> hash = r1cs_HFAL_ppzksnark_hash<ppT>(std::move(sigma_g1));
...
template <typename ppT>
r1cs_HFAL_ppzksnark_keypair<ppT> r1cs_HFAL_ppzksnark_xp2_generator(r1cs_HFAL_ppzksnark_pp<ppT> &pp, accumulation_vector<libff::G1<ppT> > &gamma_F){
    ...
    r1cs_HFAL_ppzksnark_proving_key<ppT> pk 
        = r1cs_HFAL_ppzksnark_proving_key<ppT>(std::move(gamma_F),std::move(T_ekF));
    r1cs_HFAL_ppzksnark_verification_key<ppT> vk 
        = r1cs_HFAL_ppzksnark_verification_key<ppT>(std::move(delta),std::move(kilo));
    
	pk.print_size();
	vk.print_size();

    return r1cs_HFAL_ppzksnark_keypair<ppT>(std::move(pp), std::move(pk), std::move(vk));

}

template <typename ppT>
r1cs_HFAL_ppzksnark_proof<ppT> r1cs_HFAL_ppzksnark_xp2_prover(const r1cs_HFAL_ppzksnark_proving_key<ppT> &pk, const r1cs_gg_ppzksnark_primary_input<ppT> &primary_input, const accumulation_vector<libff::G1<ppT>> &ax){
    ...
    r1cs_HFAL_ppzksnark_proof<ppT> proof
        = r1cs_HFAL_ppzksnark_proof<ppT>(std::move(pi));
